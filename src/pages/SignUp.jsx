                                ...
                                <div class="grid w-full gap-y-8">
                                    <div class="flex-row flex justify-between">
                                        <div class=" w-[45%]">
                                            <input
                                                ...
                                                className={`py-3 px-4 block 3xl:text-xl 3xl:py-5 placeholder:3xl:text-lg w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 `}
                                                required
                                    ...
                                    <div>
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`py-3 px-4 block 3xl:text-xl 3xl:py-5 placeholder:3xl:text-lg w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 ${formData.password == formData.confirmPassword
                                                ? "border-none"
                                                : "border-red-500 focus:border-red-500 focus:ring-red-500"
                                                }`}
                                            required
